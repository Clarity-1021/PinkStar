...
public class CommentCourseAdapter extends BaseAdapter {

    private List<Course> courses;

    public CommentCourseAdapter(Context context, List<Course> courses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.comment_course_list_view, null);
        }
